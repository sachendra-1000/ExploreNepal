...
export default function Hotels() {
  ...
  useEffect(() => {
    const unsubscribe = subscribeToHotels((data: any[]) => {
      setHotels(data)
      setLoading(false)
    })
    return () => unsubscribe()
    ...
    <div className="bg-slate-50 min-h-screen pb-24">
      ...
      <section className="relative h-[400px] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="/image/Pokhara Lakeside Escape.jpg" alt="Hotels in Nepal" className="w-full h-full object-cover" />
        ...
        <div className="container-custom relative z-10 text-center space-y-4 px-4">
          ...
          >
            Luxury <span className="text-blue-500">Accommodations</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Experience world-class hospitality and breathtaking views at our handpicked hotels across Nepal.
          </motion.p>
        </div>
      </section>
